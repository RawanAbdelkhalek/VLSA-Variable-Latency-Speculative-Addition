...
HD_PWD='F:/Intro to computer archeticture/Project/16bit/16bit.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log inbetween.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inbetween.tcl
